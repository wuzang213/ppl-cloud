...
import static com.hmdp.common.constants.RedisConstants.VIEW_SHOP_KEY;

/**
 * 店铺浏览量：定时把 Redis 聚合计数投递到 Kafka，由消费端批量刷 MySQL。
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class ShopViewProducerTask {
